...
export const seedPathshala = onRequest({}, async (req, res) => {
  ...
  const classes = [
    ...
    { id: "class3", title: "Navkar Mantra & Poojan", titleHi: "नवकार मंत्र और पूजन", description: "Daily prayers", descriptionHi: "दैनिक प्रार्थना और पूजन", teacherId: "teacher1", teacherName: "Sapna Ji", language: "hindi", dayOfWeek: [0, 6], time: "09:00", duration: 60, youtubeLink: "", active: true, ageGroup: "all", level: "all" },
